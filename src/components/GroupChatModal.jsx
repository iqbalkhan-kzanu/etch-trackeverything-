...
export default function GroupChatModal({ currentUser, group, onClose, onRead }) {
  ...
  return (
    <div className="fixed inset-0 bg-ink/50 backdrop-blur-sm flex items-center justify-center p-6 z-50">
      <div className="relative bg-surface border border-line rounded-xl w-full max-w-md shadow-xl flex flex-col overflow-hidden" style={{ height: '620px' }}>
        <div className="flex items-center justify-between px-5 py-4 border-b border-line shrink-0">
          <div className="min-w-0">
            <p className="font-semibold text-ink truncate">{group.name}</p>
            <p className="font-mono text-[11px] uppercase tracking-wider text-ink-muted truncate">
